...
<div class="category-filter" style="text-align: center; margin-bottom: 3rem;">
  <a href="{{ '/blog/' | relative_url }}" class="filter-btn active">All Posts</a>
  <a href="{{ '/blog/category/retirement/' | relative_url }}" class="filter-btn">Retirement</a>
  <a href="{{ '/blog/category/taxes/' | relative_url }}" class="filter-btn">Tax Tips</a>
  <a href="{{ '/blog/category/credit-cards/' | relative_url }}" class="filter-btn">Credit Cards</a>
  <a href="{{ '/blog/category/travel/' | relative_url }}" class="filter-btn">Travel</a>
</div>

<div class="post-list-single-column">
  {% assign sorted_posts = site.posts | sort: 'date' | reverse %}
  
  <!-- Display all posts (you can add limit:20 for pagination later) -->
...
{% else %}
  <div class="post-count" style="text-align: center; margin: 3rem 0; color: var(--text-muted);">
    <p>Showing {{ site.posts.size }} posts</p>
  </div>
{% endif %}
